...
load("list_models_rutgers_01.RData")
load("list_models_HED_01.RData")

load("list_models_rutgers_02.RData")
load("list_models_HED_02.RData")

load("list_models_rutgers_03.RData")
load("list_models_HED_03.RData")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_HED_1 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
...
total_eff_outfit_HED_1 <- FormatGEEOutput(total_eff_fit_HED_1)
total_eff_N_HED_1 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_HED_1$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_HED_1 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        ...
        caption = paste("Outcome: Count of past-month heavy drinking days; N = ", total_eff_N_HED_1, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_rutgers_1 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                        + qualitative_role_overload + quantitative_role_overload, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")

total_eff_outfit_rutgers_1 <- FormatGEEOutput(total_eff_fit_rutgers_1)
total_eff_N_rutgers_1 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_rutgers_1$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_rutgers_1 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  mutate(parameter = gsub("_"," ", .data[["parameter"]])) %>%
  mutate(parameter = gsub(":"," x ", .data[["parameter"]])) %>%
  select(parameter, everything()) %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", total_eff_N_rutgers_1, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_HED_1 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_1 <- geem(DASS ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                + qualitative_role_overload + quantitative_role_overload, 
...
outfit_DASS_1 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: DASS; N = ", N_DASS_1, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_rutgers_1 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                        + qualitative_role_overload + quantitative_role_overload + DASS, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_1 <- geem(DASS ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                + qualitative_role_overload + quantitative_role_overload, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "gaussian")
...
outfit_rutgers_1 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", N_rutgers_1, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
list_models_HED <- list_models_HED_01
list_models_rutgers <- list_models_rutgers_01
```
...
summary_qualitative_role_overload %>%
  kable(booktabs = TRUE, align = c('c','c','c'), caption = "DASS-mediated effect of Qualitative Role Overload on Drinking Outcome (No. of Heavy Drinking Days)")  %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  

summary_quantitative_role_overload %>%
  kable(booktabs = TRUE, align = c('c','c','c'), caption = "DASS-mediated effect of Quantitative Role Overload on Drinking Outcome (No. of Heavy Drinking Days)")  %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
summary_qualitative_role_overload %>%
  kable(booktabs = TRUE, align = c('c','c','c'), caption = "DASS-mediated effect of Qualitative Role Overload on Drinking Outcome (RAPI score)")  %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  

summary_quantitative_role_overload %>%
  kable(booktabs = TRUE, align = c('c','c','c'), caption = "DASS-mediated effect of Quantitative Role Overload on Drinking Outcome (RAPI score)")  %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_HED_2 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
...
total_eff_outfit_HED_2 <- FormatGEEOutput(total_eff_fit_HED_2)
total_eff_N_HED_2 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_HED_2$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_HED_2 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  mutate(parameter = gsub("_"," ", .data[["parameter"]])) %>%
  mutate(parameter = gsub(":"," x ", .data[["parameter"]])) %>%
  select(parameter, everything()) %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Count of past-month heavy drinking days; N = ", total_eff_N_HED_2, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_rutgers_2 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                               + time + qualitative_role_overload + quantitative_role_overload  
                                               + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")

total_eff_outfit_rutgers_2 <- FormatGEEOutput(total_eff_fit_rutgers_2)
total_eff_N_rutgers_2 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_rutgers_2$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_rutgers_2 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  mutate(parameter = gsub("_"," ", .data[["parameter"]])) %>%
  mutate(parameter = gsub(":"," x ", .data[["parameter"]])) %>%
  select(parameter, everything()) %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", total_eff_N_rutgers_2, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_HED_2 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                               + time + qualitative_role_overload + quantitative_role_overload  
                                               + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms
                                               + DASS + time:DASS, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_2 <- geem(DASS ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                + time + qualitative_role_overload + quantitative_role_overload  
                                                + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "gaussian")

outfit_DASS_2 <- FormatGEEOutput(fit_DASS_2)
N_DASS_2 <- length(setdiff(unique(dat_analysis$ParticipantID), fit_DASS_2$dropped))
```
...
outfit_DASS_2 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: DASS; N = ", N_DASS_2, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_rutgers_2 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                       + time + qualitative_role_overload + quantitative_role_overload  
                                                       + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms
                                                       + DASS + time:DASS, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_2 <- geem(DASS ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                    + time + qualitative_role_overload + quantitative_role_overload  
                                                    + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "gaussian")
...
outfit_rutgers_2 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", N_rutgers_2, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
list_models_HED <- list_models_HED_02
list_models_rutgers <- list_models_rutgers_02
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_HED_3 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                               + time + qualitative_role_overload + quantitative_role_overload  
                                               + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")

total_eff_outfit_HED_3 <- FormatGEEOutput(total_eff_fit_HED_3)
total_eff_N_HED_3 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_HED_3$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_HED_3 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  mutate(parameter = gsub("_"," ", .data[["parameter"]])) %>%
  mutate(parameter = gsub(":"," x ", .data[["parameter"]])) %>%
  select(parameter, everything()) %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Count of past-month heavy drinking days; N = ", total_eff_N_HED_3, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_fit_rutgers_3 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                               + time + qualitative_role_overload + quantitative_role_overload  
                                               + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")

total_eff_outfit_rutgers_3 <- FormatGEEOutput(total_eff_fit_rutgers_3)
total_eff_N_rutgers_3 <- length(setdiff(unique(dat_analysis$ParticipantID), total_eff_fit_rutgers_3$dropped))
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
total_eff_outfit_rutgers_3 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  mutate(parameter = gsub("_"," ", .data[["parameter"]])) %>%
  mutate(parameter = gsub(":"," x ", .data[["parameter"]])) %>%
  select(parameter, everything()) %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", total_eff_N_rutgers_3, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_HED_3 <- geem(HED ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                       + time + qualitative_role_overload + quantitative_role_overload  
                                                       + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_3 <- geem(DASS ~ sex + race + age + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                    + time + qualitative_role_overload + quantitative_role_overload  
                                                    + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "gaussian")

outfit_DASS_3 <- FormatGEEOutput(fit_DASS_3)
N_DASS_3 <- length(setdiff(unique(dat_analysis$ParticipantID), fit_DASS_3$dropped))
```
...
outfit_DASS_3 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: DASS; N = ", N_DASS_3, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_rutgers_3 <- geem(rutgers ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                       + time + qualitative_role_overload + quantitative_role_overload  
                                                       + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms
                                                       + DASS + I(DASS*DASS) + time:DASS + time:I(DASS*DASS), 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "quasipoisson")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_DASS_3 <- geem(DASS ~ sex + race + age + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress + injunctive_workplace_norms
                                                    + time + qualitative_role_overload + quantitative_role_overload  
                                                    + time:qualitative_role_overload + time:quantitative_role_overload + time:injunctive_workplace_norms, 
                  data = dat_analysis, id = ParticipantID, waves = time, corstr = "exchangeable", family = "gaussian")
...
outfit_rutgers_3 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", N_rutgers_3, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
list_models_HED <- list_models_HED_03
list_models_rutgers <- list_models_rutgers_03
```
