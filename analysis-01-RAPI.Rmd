...
(H1a): More permissive peer drinking norms are associated with an increase in alcohol misuse among young adults transitioning from college to work _(see Model 1a)_

(H1b): Role overload is associated with an increase in alcohol misuse among young adults transitioning from college to work _(see Model 1a)_

(H4) The effect of drinking norms on alcohol misuse intensifies over time: It is stronger during the late onboarding phase than the early onboarding phase _(see Model 2a)_

(H5): During the early onboarding phase, the effect of peer drinking norms on employee alcohol misuse is moderated by psychological distress such that its effect on alcohol misuse is attenuated as a function of psychological distress _(see Model 8a)_
...
outfit_rutgers_5 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Rutgers Alcohol Problem Index; N = ", N_rutgers_5,   "; QIC = ", round(QIC(fit_rutgers_5), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
...
outfit_rutgers_6 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Rutgers Alcohol Problem Index; N = ", N_rutgers_6,   "; QIC = ", round(QIC(fit_rutgers_6), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_rutgers_7 <- geem(rutgers ~ sex + race + age 
                                + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress
                                + injunctive_workplace_norms + qualitative_role_overload + quantitative_role_overload
                                + DASS + injunctive_workplace_norms:DASS
                                + time, 
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_rutgers_8 <- geem(rutgers ~ sex + race + age 
                                + baseline_rutgers + baseline_social_desirability + baseline_impulsivity + lifestress
                                + descriptive_workplace_norms + qualitative_role_overload + quantitative_role_overload
                                + DASS + descriptive_workplace_norms:DASS
                                + time, 
...
outfit_rutgers_8 <- FormatGEEOutput(fit_rutgers_8)
N_rutgers_8 <- length(setdiff(unique(dat_analysis$ParticipantID), fit_rutgers_8$dropped))
```
...
outfit_rutgers_7 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Rutgers Alcohol Problem Index; N = ", N_rutgers_7,   "; QIC = ", round(QIC(fit_rutgers_7), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
...
outfit_rutgers_8 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Rutgers Alcohol Problem Index; N = ", N_rutgers_8, "; QIC = ", round(QIC(fit_rutgers_8), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
