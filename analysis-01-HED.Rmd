...
outfit_HED_1 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        ...
        caption = paste("Outcome: HED; N = ", N_HED_1, sep=""), escape = FALSE) %>%
...
outfit_HED_2 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_2, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
outfit_HED_3 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_3, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
...
outfit_HED_4 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_4, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
outfit_HED_5 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_5, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
...
outfit_HED_6 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_6, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
ss_tab_5 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  select(parameter, everything()) %>%
  kable(booktabs = TRUE, align = c('c','c','c','c','c','c','c'), caption = paste("Outcome: HED; N = ", N_HED_5, "; Norms Covariate: Injunctive", sep="")) %>%
...
ss_tab_6 %>%
  mutate(parameter = as.character(row.names(.))) %>%
  select(parameter, everything()) %>%
  kable(booktabs = TRUE, align = c('c','c','c','c','c','c','c'), caption = paste("Outcome: HED; N = ", N_HED_6, "; Norms Covariate: Descriptive",  sep="")) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position", "scale_down"))  
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Calculate effects at late onboarding phase
Lmat_low <- as.matrix(c(0,0,0,0, # intercept, sex, race, age
                        0,0,0,0, # end with lifestress
                        # END: control variables
                        1,0,0,0,
...
ss_tab_5 <- rbind(ss_low_5, ss_mod_5, ss_hig_5)
row.names(ss_tab_5) <- c("At late onboarding phase: effect of norms at low DASS",
                         "At late onboarding phase: effect of norms at moderate DASS",
                         "At late onboarding phase: effect of norms at high DASS")
...
ss_tab_6 <- rbind(ss_low_6, ss_mod_6, ss_hig_6)
row.names(ss_tab_6) <- c("At late onboarding phase: effect of norms at low DASS",
                         "At late onboarding phase: effect of norms at moderate DASS",
                         "At late onboarding phase: effect of norms at high DASS")
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_HED_7 <- geem(HED ~ sex + race + age 
                                + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress
                                + injunctive_workplace_norms + qualitative_role_overload + quantitative_role_overload
                                + DASS + injunctive_workplace_norms:DASS
                                + time
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
fit_HED_8 <- geem(HED ~ sex + race + age 
                                + baseline_HED + baseline_social_desirability + baseline_impulsivity + lifestress
                                + descriptive_workplace_norms + qualitative_role_overload + quantitative_role_overload
                                + DASS + descriptive_workplace_norms:DASS
                                + time
...
outfit_HED_8 <- FormatGEEOutput(fit_HED_8)
N_HED_8 <- length(setdiff(unique(dat_analysis$ParticipantID), fit_HED_8$dropped))
```
...
outfit_HED_7 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_7, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
...
outfit_HED_8 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: HED; N = ", N_HED_8, sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
library(MuMIn)
all_qic <- QIC(fit_HED_1, fit_HED_2, fit_HED_3, fit_HED_4, fit_HED_5, fit_HED_6, fit_HED_7, fit_HED_8)
all_qic <- data.frame(Table = c(2,3,4,5,6,7,12,13), QIC = all_qic$QIC)

all_qic %>%
  kable(booktabs = TRUE, align = c('c','c'),
        col.names = c("Table No.", "QIC"),
        caption = paste("Outcome: HED", sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
