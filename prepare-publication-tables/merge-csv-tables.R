...
injunctive_model_04 <- read.csv("prepare-publication-tables/RAPI/injunctive_model_04.csv") %>% select(-p)
...
all_models <- full_join(x = all_models, y = injunctive_model_04, by = "parameter")
...
injunctive_model_07 <- read.csv("prepare-publication-tables/DASS/baseline_RAPI_model_07.csv") %>% select(-p)
all_models <- full_join(x = injunctive_model_06, y = injunctive_model_07, by = "parameter")
...
injunctive_model_04 <- read.csv("prepare-publication-tables/HED/injunctive_model_04.csv") %>% select(-p)
...
injunctive_model_07 <- read.csv("prepare-publication-tables/DASS/baseline_HED_model_07.csv") %>% select(-p)
all_models <- full_join(x = injunctive_model_06, y = injunctive_model_07, by = "parameter")
colnames(all_models) <- c("Parameter", rep(c("Estimate","SE"), times=2))
