...
list_models_rutgers <- parLapply(cl=cl, 
                                 ...
                                 fun=function(curr_bootdat){
                                   ...
                                   tab_rutgers_injunctive <- FormatGEEOutput(fit_rutgers_injunctive)
                                   tab_rutgers_descriptive <- FormatGEEOutput(fit_rutgers_descriptive)
...
# Save output
list_models_rutgers_02a <- list_models_rutgers
save(list_models_rutgers_02a, file = "list_models_rutgers_02a.RData")
...
# Save output
list_models_HED_02a <- list_models_HED
save(list_models_HED_02a, file = "list_models_HED_02a.RData")
