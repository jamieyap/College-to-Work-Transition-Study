...
save(list_models_rutgers_02c, file = "list_models_rutgers_02c.RData")
...
# Save output
list_models_HED_02c <- list_models_HED
save(list_models_HED_02c, file = "list_models_HED_02c.RData")
