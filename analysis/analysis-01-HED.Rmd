---
title: "Test Hypotheses H1a, H1b, and H4 with number of past-month heavy drinking days (HED) as the outcome"
author: 
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_1, "prepare-publication-tables/HED/injunctive_model_01.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_2, "prepare-publication-tables/HED/descriptive_model_01.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_3, "prepare-publication-tables/HED/injunctive_model_02.csv", row.names=FALSE)
write.csv(ss_fit_HED_3, "prepare-publication-tables/HED/injunctive_ss_model_02.csv", row.names=FALSE)
```
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Qualitative Role Overload (time=0)")
qualitative_role_overload_0 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Quantitative Role Overload (time=0)")
quantitative_role_overload_0 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Norms (time=0)")
norms_0 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Qualitative Role Overload (time=1)")
qualitative_role_overload_1 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Quantitative Role Overload (time=1)")
quantitative_role_overload_1 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
Lmat <- matrix(c(0,0,0,0,0,0,0,0,
               ...
               byrow=TRUE, nrow=1)
Lmat_labels <- c("Norms (time=1)")
norms_1 <- GetSS(use_this_model = fit_HED_4, L = Lmat, contrast_labels = Lmat_labels)
...
ss_fit_HED_4 <- dat_all_ss
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_4, "prepare-publication-tables/HED/descriptive_model_02.csv", row.names=FALSE)
write.csv(ss_fit_HED_4, "prepare-publication-tables/HED/descriptive_ss_model_02.csv", row.names=FALSE)
```
