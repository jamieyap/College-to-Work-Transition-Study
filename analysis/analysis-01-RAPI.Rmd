...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_2, "prepare-publication-tables/RAPI/descriptive_model_01.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_4, "prepare-publication-tables/RAPI/descriptive_model_02.csv", row.names=FALSE)
write.csv(ss_fit_rutgers_4, "prepare-publication-tables/RAPI/descriptive_ss_model_02.csv", row.names=FALSE)
```
