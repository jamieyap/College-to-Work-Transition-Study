---
title: "Test H1c with RAPI as the outcome"
author: 
...
(H1c): The effect of role overload on alcohol misuse is mediated by psychological distress _(see Model 3 and Model 4)_
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_2, "prepare-publication-tables/RAPI/descriptive_model_03.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_DASS_1, "prepare-publication-tables/DASS/baseline_RAPI_model_04.csv", row.names=FALSE)
```
...
# Estimate Mediated Effect using Model 3 and Model 4


```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Read in bootstrap estimates
load("bootstrap/list_models_rutgers_02a.RData")
alpha <- 0.05
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/injunctive_qualitative_role_overload_mediated_effect_model03_and_model_04.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/injunctive_quantitative_role_overload_mediated_effect_model03_and_model_04.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/descriptive_qualitative_role_overload_mediated_effect_model03_and_model_04.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/descriptive_quantitative_role_overload_mediated_effect_model03_and_model_04.csv")
```
