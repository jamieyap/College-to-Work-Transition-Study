---
title: "Test H2 and H3 with number of past-month heavy drinking days (HED) as the outcome"
author: 
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_2, "prepare-publication-tables/HED/descriptive_model_05.csv", row.names=FALSE)
```
...
outfit_HED_2 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Number of past-month heavy drinking days (HED); N = ", N_HED_2,  "; QIC = ", round(QIC(fit_HED_2), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_3, "prepare-publication-tables/HED/injunctive_model_07.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_4, "prepare-publication-tables/HED/descriptive_model_07.csv", row.names=FALSE)
```
...
outfit_HED_4 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: Number of past-month heavy drinking days (HED); N = ", N_HED_4,  "; QIC = ", round(QIC(fit_HED_4), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
load("bootstrap/list_models_HED_02b.RData")
alpha <- 0.05
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/injunctive_qualitative_role_overload_mediated_effect_model05_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/injunctive_quantitative_role_overload_mediated_effect_model05_and_model_06.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/descriptive_qualitative_role_overload_mediated_effect_model05_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/descriptive_quantitative_role_overload_mediated_effect_model05_and_model_06.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Read in bootstrap estimates
load("bootstrap/list_models_HED_02c.RData")
alpha <- 0.05
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/injunctive_qualitative_role_overload_mediated_effect_model07_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/injunctive_quantitative_role_overload_mediated_effect_model07_and_model_06.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/descriptive_qualitative_role_overload_mediated_effect_model07_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/descriptive_quantitative_role_overload_mediated_effect_model07_and_model_06.csv")
```
