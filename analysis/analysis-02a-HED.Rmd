---
title: "Test H1c with number of past-month heavy drinking days (HED) as the outcome"
author: 
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_HED_2, "prepare-publication-tables/HED/descriptive_model_03.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_DASS_1, "prepare-publication-tables/DASS/baseline_HED_model_04.csv", row.names=FALSE)
```
...
load("bootstrap/list_models_HED_02a.RData")
alpha <- 0.05
```
...
for(i in 1:length(list_models_HED_02a)){
  curr_model_estimates <- list_models_HED_02a[[i]]
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/injunctive_qualitative_role_overload_mediated_effect_model03_and_model_04.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/injunctive_quantitative_role_overload_mediated_effect_model03_and_model_04.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/HED/descriptive_qualitative_role_overload_mediated_effect_model03_and_model_04.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/HED/descriptive_quantitative_role_overload_mediated_effect_model03_and_model_04.csv")
```
