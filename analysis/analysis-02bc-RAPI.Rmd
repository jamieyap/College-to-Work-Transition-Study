---
title: "Test H2 and H3 with RAPI as the outcome"
author: 
...
(H2): The distress-mediated effect of role overload on alcohol misuse weakens over time: It is stronger during the early onboarding phase than the late onboarding phase _(see Model 5 and Model 6)_

(H3): During the early onboarding phase, the distress-mediated effect of role overload on alcohol misuse is curvilinear; it diminishes to the extent that psychological distress increases _(see Model 7 and Model 6)_
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_2, "prepare-publication-tables/RAPI/descriptive_model_05.csv", row.names=FALSE)
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_3, "prepare-publication-tables/RAPI/injunctive_model_07.csv", row.names=FALSE)
```
...
outfit_rutgers_3 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", N_rutgers_3,  "; QIC = ", round(QIC(fit_rutgers_3), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(outfit_rutgers_4, "prepare-publication-tables/RAPI/descriptive_model_07.csv", row.names=FALSE)
```
...
outfit_rutgers_4 %>%
  ...
  kable(booktabs = TRUE, align = c('c','c','c','c'),
        col.names = linebreak(c("Parameter","Estimates","SE","p-value"), align = "c"),
        caption = paste("Outcome: RAPI; N = ", N_rutgers_4,  "; QIC = ", round(QIC(fit_rutgers_4), digits = 2), sep=""), escape = FALSE) %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))  
```
...
# Estimate Mediated Effect using Model 5 and Model 6


```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Read in bootstrap estimates
load("bootstrap/list_models_rutgers_02b.RData")
alpha <- 0.05
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
list_params_rutgers_02b <- list()

for(i in 1:length(list_models_rutgers_02b)){
  curr_model_estimates <- list_models_rutgers_02b[[i]]
  ...
  list_params_rutgers_02b <- append(list_params_rutgers_02b, list(curr_params_rutgers))
}
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
bootdat_params_rutgers <- bind_rows(list_params_rutgers_02b) %>%
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/injunctive_qualitative_role_overload_mediated_effect_model05_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/injunctive_quantitative_role_overload_mediated_effect_model05_and_model_06.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/descriptive_qualitative_role_overload_mediated_effect_model05_and_model_06.csv")
```

```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/descriptive_quantitative_role_overload_mediated_effect_model05_and_model_06.csv")
```

\newpage

# Estimate Mediated Effect using Model 7 and Model 6


```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Read in bootstrap estimates
load("bootstrap/list_models_rutgers_02c.RData")
alpha <- 0.05
```
...
for(i in 1:length(list_models_rutgers_02c)){
  curr_model_estimates <- list_models_rutgers_02c[[i]]
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/injunctive_qualitative_role_overload_mediated_effect_model07_and_model_06.csv")
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/injunctive_quantitative_role_overload_mediated_effect_model07_and_model_06.csv")
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_qualitative_role_overload, "prepare-publication-tables/RAPI/descriptive_qualitative_role_overload_mediated_effect_model07_and_model_06.csv")
```


```{r, echo = FALSE, message = FALSE, warning = FALSE}
write.csv(summary_quantitative_role_overload, "prepare-publication-tables/RAPI/descriptive_quantitative_role_overload_mediated_effect_model07_and_model_06.csv")
```
